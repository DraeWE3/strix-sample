...
import Cardcon1 from '../../assets/img/longformat1.png'
import Cardcon2 from '../../assets/img/longformat2.png'
import Cardcon3 from '../../assets/img/longformat3.png'
import Cardcon4 from '../../assets/img/longformat4.png'
import ProjectCarousel from "../../components/projectCarouel";
import Button from "../../components/Button";
import ProjectCircle from '../../assets/img/project-circle.webp'
import HeroImg from '../../assets/img/pro-bg.webp'
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link to='/reel'><button className="back-button">
